        ...
        bool GameConfig::loadConfigFile(const char *strPath)
        {
            ...
            for (auto it = vecDomain.begin(); it != vecDomain.end(); ++it)
            {
                if (*it == "GameConfig")
                {
                    ...
                    nBetTime = TC_Common::strto<tars::Int32>(tc_config.get(strOperateNode + "<nBetTime>", "15"));
                    nOpenTime = TC_Common::strto<tars::Int32>(tc_config.get(strOperateNode + "<nOpenTime>", "3"));
                    ...
                    nMinSitScore = TC_Common::strto<tars::Int32>(tc_config.get(strOperateNode + "<nMinSitScore>", "10000"));
